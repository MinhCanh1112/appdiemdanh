...
import com.example.appdiemdanh.databinding.FragmentSundayBinding;
...
public class SundayFragment extends Fragment {
    ...
    FragmentSundayBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_sunday,container,false);
    ...
    private void getTimeDiemdanh() {
        ...
        attendanceViewModel.getTimeDiemdanh(iduser,date).observe(getActivity(),dateTimediemdanhs -> {
            binding.recycSunday.setLayoutManager(new LinearLayoutManager(getActivity()));
            mAdapter = new FragmentAdapter();
            binding.recycSunday.setAdapter(mAdapter);
