...
import com.example.appdiemdanh.databinding.FragmentTuesdayBinding;
...
public class TuesdayFragment extends Fragment {
    ...
    FragmentTuesdayBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_tuesday,container,false);
    ...
    private void getTimeDiemdanh() {
        ...
        attendanceViewModel.getTimeDiemdanh(iduser,date).observe(getActivity(),dateTimediemdanhs -> {
            binding.recycTuesday.setLayoutManager(new LinearLayoutManager(getActivity()));
            mAdapter = new FragmentAdapter();
            binding.recycTuesday.setAdapter(mAdapter);
