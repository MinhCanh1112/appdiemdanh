...
import com.example.appdiemdanh.databinding.FragmentWednesdayBinding;
...
public class WednesdayFragment extends Fragment {
    ...
    FragmentWednesdayBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_wednesday,container,false);
    ...
    private void getTimeDiemdanh() {
        ...
        attendanceViewModel.getTimeDiemdanh(iduser,date).observe(getActivity(),dateTimediemdanhs -> {
            binding.recycWednesday.setLayoutManager(new LinearLayoutManager(getActivity()));
            mAdapter = new FragmentAdapter();
            binding.recycWednesday.setAdapter(mAdapter);
